              ...
              <Table size="small" aria-label="purchases">
                <TableHead>
                  ...
                  <TableCell>Work Type</TableCell>
                    <TableCell style={{visibility:'hidden'}}>Type</TableCell>
                    
                    <TableCell>Total Part Works (nos.)</TableCell>
                    <TableCell>Land not clear (nos.)</TableCell>
                    <TableCell>AA Not Entered (nos.)</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  {row.history.map((historyRow) => (
                    ...
                    <TableRow key={historyRow.date}>
                      ...
                      <TableCell component="th" scope="row">{historyRow.total}</TableCell>
...
const rows = [
  createData('SE AC-1', "Total", 6.0, 24, 4.0, 3, "EE(S)(Ahmedabad)"),
  createData('SE AC-2', "Total", 9.0, 37, 4.3, 4, "EE(Ahmedabad)"),
  createData('SE VC', "Total", 16.0, 24, 6.0, 3, "EE(Ahmedabad)"),
  createData('SE SC', "Total", 3.7, 67, 4.3, 2, "EE(Ahmedabad)"),
  createData('SE RC1', "Total", 16.0, 49, 3.9, 1, "EE(Ahmedabad)"),
];
